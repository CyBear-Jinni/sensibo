...
class SensiboElements extends SensiboBase {
  ...
  }) : super(type: SensiboProductModels.elements);

  factory SensiboElements.fromMap(Map<String, dynamic> map) {
    return SensiboElements(
      ...
      room: map['room'],
      acState: map['acState'],
      lastStateChange: map['lastStateChange'],
      lastStateChangeToOn: map['lastStateChange'],
      lastStateChangeToOff: map['lastStateChangeToOff'],
      ...
      motionSensors: map['motionSensors'],
      tags: map['tags'],
      timer: map['timer'],
      schedules: map['schedules'],
      motionConfig: map['motionConfig'],
      filtersCleaning: map['filtersCleaning'],
      serviceSubscriptions: map['serviceSubscriptions'],
      ...
      warrantyEligibleUntil: map['warrantyEligibleUntil'],
  ...
  Map<String, dynamic> lastStateChange;
  dynamic lastStateChangeToOn;
  dynamic lastStateChangeToOff;
  Map<String, dynamic> warrantyEligibleUntil;
}
